...
const Embeddings: NextPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch("/api/generate-embeddings2", {
      method: "POST",
  ...
  return (
    <div className="flex flex-col items-center max-w-xl m-auto text-center">
      ...
      <p className="mb-4">
        Paste stuff to geneate embeddings using the OpenAI API, and add the embeddings to the Supabase embeddings table.
      </p>
